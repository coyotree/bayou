...
simpars$theta <- c(0, ?, ?)  #Type simpars$ntheta numbers
...
1. Consider the following scenarios, how would you generate them by changing the parameters of an OU model (if at all)?
  ...
  + Lineages very close to their adaptive optimum with very large amounts of phylogenetic signal and very narrow adaptive zones.
...
qs <- quantile(?, quantiles) ## Use 'alfs' and math to calculate the quantiles of phylogenetic half-life
round(qs, 2)
